															...
															<div className='Frame_4'>
																<div className='Group_4'>
																	<div className='Frame_5'>
																		<img className='text0' src = {ImgAsset.MacBookPro141_text0} />
																	</div>
																</div>
															</div>
														</div>
															...
															<div className='Frame_6'>
																<div className='Group_6'>
																	<div className='Frame_7'>
																		<img className='text1' src = {ImgAsset.MacBookPro141_text1} />
																	</div>
																</div>
															</div>
														</div>
										...
										<div className='Group_7'>
											<div className='Frame_8'>
												<div className='Group_8'>
													<div className='icon0'>
														<img className='Vector' src = {ImgAsset.MacBookPro141_Vector} />
													</div>
												</div>
											</div>
										</div>
														...
														<div className='Frame_13'>
															<div className='Group_13'>
																<div className='Frame_14'>
																	<img className='text0_1' src = {ImgAsset.MacBookPro141_text0_1} />
																</div>
															</div>
														</div>
													</div>
														...
														<div className='Frame_15'>
															<div className='Group_15'>
																<div className='Frame_16'>
																	<img className='text1_1' src = {ImgAsset.MacBookPro141_text1_1} />
																</div>
															</div>
														</div>
													</div>
										...
										<div className='Frame_17'>
											<div className='Group_17'>
												<div className='icon0_1'>
													<img className='Vector_2' src = {ImgAsset.MacBookPro141_Vector_2} />
												</div>
											</div>
										</div>
									</div>
